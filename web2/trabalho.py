...
@app.route('/listar')
def listar():
    return render_template('listar.html', titulo_pagina = 'Tipos', lista = lista_cervejas)
...
@app.route ('/pedido')
def pedido():
    return render_template('pedido.html', titulo_pagina = 'Fazer pedido')    
